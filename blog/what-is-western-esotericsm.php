...
<head>
  <meta charset="UTF-8">
  <title>OddPillars - What is Western Esotericism</title>
...
<style>
.blog1bkg {
  background-image: url("../images/blog1bkg.jpeg");
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.10&appId=371767616187004";
...
<div class="blog1bkg">
  ...
  <div class="container blogcon">
    <h1 align="center">What is Western Esotericism?</h1>
    <h3 align="center">
      ...
      <div class="container-fluid">
          <p>
            ...
            talking about an occult science that's veiled in allegories and symbols, that is intended for only a select few to understand, and has several different layers of meaning.
             It's antonym, exoteric is the surface level message that is in plain view.
          </p>

          <p>
            If you've ever taken a literary English class, you're probably already familiar with this. Authors will convey messages and ideas through metaphors and symbols. For instance, an Author might decide to make something the color black, in order to associate it with the astrological properties of Saturn.
            Upon looking for the hidden meaning behind symbols, a problem arises. It's hard to tell what's intentional and what isn't. In other words, sometimes the curtains are red not for any symbolical meaning, but are red just because the author wanted them to be red.
            It's because of this that the aspiring occult student faces a daunting task. This task involves the constant persuit of trying to figuring out what the intended messages are in ancient mythology and mysticism.
          </p>
          ...
          <img src="https://www.oddpillars.com/images/maj.jpg" class="img-responsive"/>
          <h4>The Magician Tarot Card depicts the Hermetic Axiom: As Above, So Below, which comes from the Emerald Tablet.</h4>
            </div>
          ...
          <p>
            Many modern day Hermeticists are introduced to Hermeticism by the Kybalion, written by Three Initiates. This text is quite popular among beginning students and new age enthusiasts. Developed Hermeticists tend to have an awkward relationship with the Kybalion because it dumbs down much of the Science and presents it's material in a very "Feel Good" way.
...
Occult Hermetic Qabalah arose alongside and united with the Christian Cabalistic involvement in the European Renaissance, becoming variously Esoteric Christian, non-Christian, or anti-Christian across its different schools in the modern era. It draws on a great many influences, most notably: Jewish Kabbalah, Western astrology, Alchemy, pagan religions, especially Egyptian and Greco-Roman (it is from the latter that the term "Hermetic" is derived), neoplatonism, gnosticism, the Enochian system of angelic magic of John Dee and Edward Kelley, hermeticism, tantra and the symbolism of the tarot. Hermetic Qabalah differs from the Jewish form in being a more admittedly syncretic system, however it shares many concepts with Jewish Kabbalah.
        ...
        <div class="row-opening">
          ...
          <img src="https://www.oddpillars.com/images/tree.png" class="img-responsive"/>
          <h5>The Qabalistic Tree of Life is depicted above. This specific depiction combines hermetic, rosicrucian, and masonic symbolism with the original Kabalistic diagram.</h5>
          </div>
          <div class="col-md-8 col-xs-8">
        ...
        <p>
          The Western Esoteric Tradition makes use of Qabalah by way of the Tree of Life, the Tarot, and gemetria.
        </p>
        ...
        <p>
          Gemetria is the alphanumeric cipher with the belief that words or phrases with identical numerical values bear some relation to each other or bear some relation to the number itself. In Hebrew, each letter also has a numerical value. When Hebrew words are reduced to their numerical values, we find that quite often different words or phrases that are related to each other share the same numerical value. This is also why Qabalah in Hebrew means accounting.
        </p>

        <p>
          The last component of the Western Esoteric Tradition is the study of magic. The magic of Western Esotericism is known as ceremonial magick. Ceremonial magic or ritual magic, also referred to as high magic and as learned magic in some cases, is a broad term used in the context of Hermeticism or Western esotericism to encompass a wide variety of long, elaborate, and complex rituals of magic. It is named as such because the works included are characterized by ceremony and a myriad of necessary accessories to aid the practitioner. It can be seen as an extension of ritual magic, and in most cases synonymous with it. Popularized by the Hermetic Order of the Golden Dawn, it draws on such schools of philosophical and occult thought as Hermetic Qabalah, Enochian magic, Thelema, and the magic of various grimoires.
        </p>

        <p>
          Ceremonial Magic differs from Witchcraft in many different ways. The first of which is that most practitioners of Witchcraft are not well versed in the Western Esoteric Tradition, and many have never heard of it's existence. Witchcraft doesn't require a strong basis of philosophical and occult philosophy to do. Moreover, most Ceremonial Magicians have a degree of skepticism in their practice. Generally speaking, the Ceremonial Magician is more concerned in the persuit of hidden knowledge and the scientific explantions for why things occur than those that practice Witchcraft.
        </p>
        ...
        <center>
<div class="fb-share-button" data-href="https://www.oddpillars.com/blog/what-is-western-esotericsm.php" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.oddpillars.com%2Fblog%2Fwhat-is-western-esotericsm.php&amp;src=sdkpreparse">Share</a></div>
<br />          <div class="fb-comments" data-href="https://www.oddpillars.com/blog/what-is-western-esotericsm.php" data-numposts="5" data-colorscheme="dark"></div>
        </center>
      </div>
